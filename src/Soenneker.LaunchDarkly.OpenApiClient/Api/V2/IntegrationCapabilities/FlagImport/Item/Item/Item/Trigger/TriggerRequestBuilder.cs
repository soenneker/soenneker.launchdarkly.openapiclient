...
using System;
namespace Soenneker.LaunchDarkly.OpenApiClient.Api.V2.IntegrationCapabilities.FlagImport.Item.Item.Item.Trigger
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v2\integration-capabilities\flag-import\{projectKey}\{integrationKey}\{integrationId}\trigger
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("Kiota", "1.0.0")]
    public partial class TriggerRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.LaunchDarkly.OpenApiClient.Api.V2.IntegrationCapabilities.FlagImport.Item.Item.Item.Trigger.TriggerRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TriggerRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v2/integration-capabilities/flag-import/{projectKey}/{integrationKey}/{integrationId}/trigger", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Soenneker.LaunchDarkly.OpenApiClient.Api.V2.IntegrationCapabilities.FlagImport.Item.Item.Item.Trigger.TriggerRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public TriggerRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/api/v2/integration-capabilities/flag-import/{projectKey}/{integrationKey}/{integrationId}/trigger", rawUrl)
        {
        }
        /// <summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.LaunchDarkly.OpenApiClient.Api.V2.IntegrationCapabilities.FlagImport.Item.Item.Item.Trigger.TriggerRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.LaunchDarkly.OpenApiClient.Api.V2.IntegrationCapabilities.FlagImport.Item.Item.Item.Trigger.TriggerRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Soenneker.LaunchDarkly.OpenApiClient.Api.V2.IntegrationCapabilities.FlagImport.Item.Item.Item.Trigger.TriggerRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
