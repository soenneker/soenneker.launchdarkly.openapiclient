...
using System;
namespace Soenneker.LaunchDarkly.OpenApiClient.Api.V2.Usage.DataExportEvents
{
    /// <summary>
    /// Builds and executes requests for operations under \api\v2\usage\data-export-events
    /// </summary>
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.LaunchDarkly.OpenApiClient.Api.V2.Usage.DataExportEvents.DataExportEventsRequestBuilder.DataExportEventsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Soenneker.LaunchDarkly.OpenApiClient.Api.V2.Usage.DataExportEvents.DataExportEventsRequestBuilder.DataExportEventsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.LaunchDarkly.OpenApiClient.Api.V2.Usage.DataExportEvents.DataExportEventsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Soenneker.LaunchDarkly.OpenApiClient.Api.V2.Usage.DataExportEvents.DataExportEventsRequestBuilder WithUrl(string rawUrl)
        {
